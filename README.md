...
### Uses new React Context API so requires use of React version >=16.3.0 ~> use @0.1.6 version of this library if you want to use it with 16.3 to 16.6 version of React.js
